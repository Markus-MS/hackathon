...
DEFAULT_SETTINGS = {
    ...
    "solver_ssh_target": "solver",
    "solver_ssh_agent": "codex",
    "solver_ssh_workspace_root": "~/ctfarena-runs",
    "solver_ssh_challenge_root": "~",
    "solver_ssh_extra_args": "",
    "runner_max_parallel_runs": os.environ.get("CTF_ARENA_MAX_PARALLEL_RUNS", "1"),
    "solver_attempts_per_challenge": "2",
    "solver_max_turns": "8",
...
NON_EMPTY_SETTINGS = {
    ...
    "solver_ssh_target",
    "solver_ssh_agent",
    "solver_ssh_workspace_root",
    "solver_ssh_challenge_root",
    "runner_max_parallel_runs",
    "solver_attempts_per_challenge",
    "solver_max_turns",
