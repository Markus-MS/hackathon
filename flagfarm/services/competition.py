...
from flagfarm.services import ctf_service, pricing, runtime_settings
from flagfarm.services.ctfd import CTFdClient, CTFdSubmitError
...
class DockerSolverBackend:
    def execute(self, *, ctf, model, challenge, account, competition_run) -> SolverResult:
        ...
        with tempfile.TemporaryDirectory(prefix="flagfarm-solver-") as tmp:
            tmp_path = Path(tmp)
